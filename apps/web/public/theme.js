...
(() => {
  ...
  document.querySelector('meta[name="theme-color"]')?.setAttribute('content', ({ warm: { light: '#fbf7f0', dark: '#24201d' }, cool: { light: '#f7f9fc', dark: '#1c1d20' }, neutral: { light: '#fafafa', dark: '#202020' } })[palette][theme]);
})();
