...
const PLANNED: { group: string; items: string[] }[] = [
  { group: 'Personalization', items: ['Response style', 'Account-wide custom instructions', 'Account-wide memory preferences', 'Notifications'] },
  { group: 'Data', items: ['Data retention'] },
