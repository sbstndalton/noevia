...
(async()=>{
 ...
 for(const [width,height] of [[320,568],[375,667],[390,844],[430,932],[640,800],[667,375],[768,1024],[1440,900]])for(const theme of ['light','dark']){
   ...
   if(width<700){
     ...
     for(const section of ['Account','Security and login','General','Personalization','Capabilities','Connectors','Diary & storage','AI providers','Usage','Data controls','Planned features']){
