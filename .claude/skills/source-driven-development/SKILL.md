...
> Vendored from addyosmani/agent-skills (MIT) — see NOTICE.md. Generic by
> design. Where it disagrees with `AGENTS.md` or `docs/agent-brief.md`, this
> repository's own rules win: in particular the verification expectations in
> `docs/agent-brief.md` (manual verification is mandatory here; a green test
> suite is not sufficient evidence) and the standing bans in "What NOT to do".
