...
| [spec-context-projection.md](spec-context-projection.md), [spec-agent-execution.md](spec-agent-execution.md) | Context layers/compaction/reduction; qualification, Prompt Architect, CodeHarness, durable work, execution nodes, browser | Context or agent-execution work |
