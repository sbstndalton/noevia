...
Active-project source refresh is deployed as `8fa1112` (358 local / 308 Linux
tests, typecheck/build pass). Public assets and service HTTP checks match. The
boot-storage preflight wrapper was used successfully; managed-volume defaults
remain generic-fresh-install only. Rollback is f7b9d95. See deployment.md.
